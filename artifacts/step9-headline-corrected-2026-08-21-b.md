...
> **Provenance.** Promoted from `processed/step9/b/preview/step9-headline-b.md` (sha256:12 `79dc9b28616a`) by `src/step9_b_7_emit_corrected.py` (sha256:12 `40854173bd3a`) at 2026-08-25T17:08:12Z, git `3e8653e`. **The promotion appended this header and section 10 and changed no figure and no sentence of the body.** The body itself was regenerated by this arm's pipeline under `decisions/0124`; it was not edited.
...
| **Generated** | 2026-08-25T17:06:21Z by `src/step9_b_3_emit.py` (sha256:12 `8d6ad8195375`) |
