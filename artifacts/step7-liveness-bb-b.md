...
**Instance:** `data-scientist-b`, namespace `bb_b` · **Date:** 2026-08-13 · **API calls: 0**
...
**Never started, same arm, same convention: 0.2721 on APPLY (denominator 1.1287); DERIV is 0.0 because that bound is degenerate.**
