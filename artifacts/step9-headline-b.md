...
> **SUPERSEDED — 2026-08-21.** The figures in the block immediately below were produced under a defective `T0` vector: `src/step9_b_1_compute.py` divided a `datetime64[us, UTC]` column by `10 ** 9`, so every premiere-anchored `T0` was epoch-**seconds ÷ 1000** — a 1970 date — instead of epoch seconds. They are correctly computed from that vector and are kept as the record of what the defect produced. The corrected figures are at the same section of `artifacts/step9-headline-corrected-2026-08-21-b.md`. **This stamp covers only the block it precedes; it exempts nothing else in this file, and every other superseded block carries its own.**
...
| outcome | share (post-liveness) | pairs | 95% CI, **LEVEL** | width | horizon |
| :--- | ---: | ---: | :--- | ---: | ---: |
| never started | **42.7682%** | 84,037 | [41.8055%, 43.7085%] | 1.9029 pp | 91 d ·**SUPERSEDED** |
...
| bound | floor | ceiling | width | on |
| :--- | ---: | ---: | ---: | :--- |
| never started | 42.7334% (84,037) | 42.7883% (84,145) | 0.0549 pp | position 5, n = 196,654 ·**SUPERSEDED** |
| started and left | 6.6309% (13,040) | 6.7387% (13,252) | 0.1078 pp | position 5, n = 196,654 ·**SUPERSEDED** |
| continued | *not published* | 50.6356% (99,577) | — | position 5, n = 196,654 ·**SUPERSEDED** |
...
| outcome | share (post-liveness) | pairs | 95% CI, **LEVEL** | width | horizon |
| :--- | ---: | ---: | :--- | ---: | ---: |
| never started | **40.0725%** | 59,034 | [38.8645%, 41.2947%] | 2.4302 pp | 91 d ·**SUPERSEDED** |
...
| bound | floor | ceiling | width | on |
| :--- | ---: | ---: | ---: | :--- |
| never started | 40.0584% (59,034) | 40.0584% (59,034) | 0.0000 pp  *(DEGENERATE — a measured zero width, not missing data)* | position 5, n = 147,370 ·**SUPERSEDED** |
| started and left | 7.3719% (10,864) | 7.4425% (10,968) | 0.0706 pp | position 5, n = 147,370 ·**SUPERSEDED** |
| continued | *not published* | 52.5697% (77,472) | — | position 5, n = 147,370 ·**SUPERSEDED** |
...
| W091_s2_premiere__step9__r6 | DERIV | never started | [+0.0093, +0.0198] pp | 0.0105 pp | 2.4302 pp | **231×** ·**SUPERSEDED** |
| W091_s2_premiere__step9__r6 | DERIV | started and left | [-0.0458, -0.0214] pp | 0.0243 pp | 0.6701 pp | **28×** ·**SUPERSEDED** |
| W091_s2_premiere__step9__r6 | DERIV | continued | [+0.0121, +0.0260] pp | 0.0139 pp | 2.4106 pp | **173×** ·**SUPERSEDED** |
...
| corner | never started | started and left | continued |
| :--- | ---: | ---: | ---: |
| never started bound, floor | 42.7334% | 6.6309% | 50.6356% ·**SUPERSEDED** |
| never started bound, ceiling | 42.7883% | 6.6838% | 50.5278% ·**SUPERSEDED** |
| started and left bound, ceiling | 42.7334% | 6.7387% | 50.5278% ·**SUPERSEDED** |
...
| corner | never started | started and left | continued |
| :--- | ---: | ---: | ---: |
| never started bound, floor | 40.0584% | 7.3719% | 52.5697% ·**SUPERSEDED** |
| never started bound, ceiling | 40.0584% | 7.4425% | 52.4992% ·**SUPERSEDED** |
...
| W091_s2_premiere__step9__r6 | DERIV | started and left | 0.1053 ·**SUPERSEDED** |
| W091_s2_premiere__step9__r6 | DERIV | started and left sub interval | 0.1053 ·**SUPERSEDED** |
