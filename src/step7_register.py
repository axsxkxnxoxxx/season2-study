...
# >>> STEP9-B 0124 ROWS -- GENERATED BY src/step9_b_13_register_0124.py, DO NOT EDIT BY HAND
# 34 rows. Every value MEASURED off artifacts/step9-headline-b.{json,md} by diffing
...
#   12 -- occurs 3 times in these two files alone
#   15 -- occurs 1 times in these two files alone
#   33 -- occurs 1 times in these two files alone
#   42 -- occurs 1 times in these two files alone
#   337 -- occurs 1 times in these two files alone
# They are small integers; registering them would flag correct counts in the same file.
#
# ALSO UNREGISTERED AND THEREFORE UNPOLICED -- 3 values whose movement under 0124 is
...
#   0.003108  ($.declared_intervals[3].ci.lower)
#   0.005374  ($.declared_intervals[3].ci.upper)
#   0.070948  ($.declared_intervals[5].ci.upper)
SUPERSEDED_IN.update({
    ("artifacts/step9-headline-b", -0.298608): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", -0.201078): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", -0.076252): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", -0.044409): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", -0.027183): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", -0.004755): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.0297): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.041222): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.0975): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.0981): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.129028): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.13259): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.216494): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.272711): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.314576): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.541371): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.7449): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.7639): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 0.9621): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 1.1262): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 1.2416): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 1.4433): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 5.841467): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 6.605406): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 9.348548): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 10.093409): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 10.896116): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 11.858255): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 16.164968): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 17.291209): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 72.844193): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 74.287524): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 81.794438): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
    ("artifacts/step9-headline-b", 83.035992): "arm b W108_s2_finale CI endpoint or CI-derived figure, produced under the per-mask frame and per-group re-seed that decisions/0124 fixed against; corrected value in step9-headline-corrected-2026-08-21-b (0124)",
})
# <<< STEP9-B 0124 ROWS
