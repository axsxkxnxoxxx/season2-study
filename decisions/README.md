...
- [ ] **Step 7** liveness rule — **ALT-BROAD restored 2026-08-13 ([0054](0054-revert-to-alt-broad-widen-the-floor.md)): not live iff no insertion after `τ1` AND NOT Continued, silence anchored at `τ1` only.** The started-and-left floor is **widened to 9.6372%**. **DERIV widened to 11.3015% by [0055](0055-deriv-floor-widened-and-the-grep-control.md)**, which `0054` left un-widened. The **four figures derived from that floor** are corrected by [0056](0056-derived-figures-and-the-dependency-list.md), which `0055` left behind. **Twelve Red Team HOLDs; the gate is OPEN.** ALT-MATCHED ([0052](0052-liveness-rule-alt-matched-adopted.md)) is **reverted** — it gave numerically identical bounds.  Both arms reran and confirmed every figure. **The gate is OPEN** — five Red Team HOLDs, the last on propagation failure #9 ([0050](0050-step7-propagation-pass-and-channel-measurement.md)), and **no review has run since**. Superseded on the way: a numeric threshold at 632 then 1,293 days ([0039](0039-step7-liveness-gate.md) suspended, [0042](0042-step7-liveness-gate-parameter-free.md) deleted it), then **PF-LIMIT**, then **ALT** ([0046](0046-liveness-rule-alt-adopted.md)).
