...
- [ ] **Step 7** liveness rule — **RULE CHANGED to ALT 2026-08-13 ([0046](0046-liveness-rule-alt-adopted.md)); reruns pending, gate OPEN.** Previously approved **with NO free parameter** ([0042](0042-step7-liveness-gate-parameter-free.md)). A pair is not live iff the account shows no insertion instant after `τ1`. The threshold was derived three times and **deleted**. **REOPENED the same day on Red Team's second HOLD** — four blocking items, of which the bias-sign error is closed by [0043](0043-liveness-bias-sign-correction.md) and three remain open. ([0039](0039-step7-liveness-gate.md) suspended, [0040](0040-step7-gate-reopened.md) reopened it once already.)
...
46. **A ruling lands in a decision entry and not in the file the agents read — five times now.**
