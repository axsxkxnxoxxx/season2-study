...
- [x] **Step 7** liveness rule — approved 2026-08-13 **with NO free parameter** ([0042](0042-step7-liveness-gate-parameter-free.md)). A pair is not live iff the account shows no insertion instant after `τ1`. The threshold was derived three times and **deleted**. ([0039](0039-step7-liveness-gate.md) suspended, [0040](0040-step7-gate-reopened.md) reopened the gate.)
