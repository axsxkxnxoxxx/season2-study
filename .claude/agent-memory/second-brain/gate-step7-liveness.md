...
> `0063`, which carries the **652** that §3 rests on — are dated **2026-08-14**.
...
| `0058` | `0057` §1, §2; the dates | **Reverted the ratio reconciliation in the entry and not in the body**, leaving `0.509` in arm a. **Published the "which is the proof" sentence**, itself an instance of the defect it certified |
