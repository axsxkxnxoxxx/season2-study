...
- [ ] **The anchor choice has no stated ground, and that is on the record.** There is no argument in Step 1 for preferring `τ2 = ⟦T0⟧ + (W + H)` to `first-S2-watch + H`. Four were attempted during review and all four failed. Step 2's marginal-lag distribution is the *start-anchored* rule's own distribution. (`artifacts/step1-amendment-continued-boundary.md` §21)
