...
- [ ] **Negative-lag report (D2), split THREE WAYS, not two: the S2 finale binds, the S1 completion
      ...
      and the binary split has nowhere to put them** — an instance would have to choose a side, and two
