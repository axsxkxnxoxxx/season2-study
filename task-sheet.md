...
- [ ] **The reference set is the 129,630 measured-gap pairs.** Open-ended gaps **cannot** be treated as infinite — they are **3.17%** of the extended set, so a 99th percentile taken over it **would itself be infinite**. The edge cases are handled by `0036` §2.3's rulings, not by the percentile. **Report the realised rate against both denominators**: 0.9843% of measured-gap pairs, 15.63% of all pairs.
